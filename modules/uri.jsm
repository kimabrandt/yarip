...
var TLD = "(" +
    ...
    "|(?:(?:(?:act|asn|(?:(?:blogspot)\\.)?com|conf|(?:(?:act|nsw|nt|qld|sa|tas|vic|wa)\\.)?edu|(?:(?:qld|sa|tas|vic|wa)\\.)?gov|id|info|net|nsw|nt|org|oz|qld|sa|tas|vic|wa)\\.)?au)" +
    "|(?:(?:(?:com)\\.)?aw)" +
    "|(?:(?:(?:biz|com|edu|gov|info|int|mil|name|net|org|pp|pro)\\.)?az)" +
    "|(?:(?:(?:co|com|edu|gov|mil|net|org|rs|unbi|unsa)\\.)?ba)" +
    "|(?:(?:(?:biz|cc|com|edu|gov|info|net|org|store|tv)\\.)?bb)" +
    ...
    "|(?:(?:(?:co|org)\\.)?bw)" +
    "|(?:(?:(?:com|gov|mil|of)\\.)?by)" +
    "|(?:(?:(?:com|edu|gov|net|org|za)\\.)?bz)" +
    "|(?:(?:(?:ab|bc|blogspot|co|gc|mb|nb|nf|nl|ns|nt|nu|on|pe|qc|sk|yk)\\.)?ca)" +
    "|(?:(?:(?:cc|co|cu|ftpaccess|game-server|myphotos|scrapping)\\.)?cc)" +
    "|(?:(?:gov\\.)?cd)" +
    "|(?:(?:blogspot\\.)?cf)" +
    "|(?:(?:blogspot\\.)?ch)" +
    ...
    "|(?:(?:(?:co|gob|gov|mil)\\.)?cl)" +
    "|(?:(?:(?:co|com|gov|net)\\.)?cm)" +
    "|(?:(?:(?:ac|ah|(?:(?:cn-north-1\\.)?compute\\.)?amazonaws|bj|com|cq|edu|fj|gd|gov|gs|gx|gz|ha|hb|he|hi|hk|hl|hn|jl|js|jx|ln|mil|mo|net|nm|nx|org|qh|sc|sd|sh|sn|sx|tj|tw|xj|xz|yn|zj)\\.)?cn)" +
    "|(?:(?:(?:africa|(?:(?:(?:(?:ap-(?:northeast-1|southeast-[1-2])|eu-west-1|sa-east-1|us-west-[1-2]|us-gov-west-1)\\.)?compute|(?:z-[1-2]\\.)?compute-1|elb|s3(?:-(?:(?:website-)?(?:ap-(?:northeast-1|southeast-[1-2])|eu-west-1|sa-east-1|us-east-1|us-west-[1-2])|(?:(?:fips|website)-)?us-gov-west-1|website-us-east-1))?)\\.)?amazonaws|appspot|ar|betainabox|blogdns|blogspot|br|cechire|cloudcontrolapp|cloudcontrolled|cn|co|codespot|de|dnsalias|dnsdojo|doesntexist|dontexist|doomdns|dreamhosters|dyn-o-saur|dynalias|dyndns-at-home|dyndns-at-work|dyndns-blog|dyndns-free|dyndns-home|dyndns-ip|dyndns-mail|dyndns-office|dyndns-pics|dyndns-remote|dyndns-server|dyndns-web|dyndns-wiki|dyndns-work|elasticbeanstalk|est-a-la-maison|est-a-la-masion|est-le-patron|est-mon-blogueur|eu|from-ak|from-al|from-ar|from-ca|from-ct|from-dc|from-de|from-fl|from-ga|from-hi|from-ia|from-id|from-il|from-in|from-ks|from-ky|from-ma|from-md|from-mi|from-mn|from-mo|from-ms|from-mt|from-nc|from-nd|from-ne|from-nh|from-nj|from-nm|from-nv|from-oh|from-ok|from-or|from-pa|from-pr|from-ri|from-sc|from-sd|from-tn|from-tx|from-ut|from-va|from-vt|from-wa|from-wi|from-wv|from-wy|gb|getmyip|googleapis|googlecode|gotdns|gr|heroku(?:app|ssl)|hobby-site|homelinux|homeunix|hu|iamallama|is-a-anarchist|is-a-blogger|is-a-bookkeeper|is-a-bulls-fan|is-a-caterer|is-a-chef|is-a-conservative|is-a-cpa|is-a-cubicle-slave|is-a-democrat|is-a-designer|is-a-doctor|is-a-financialadvisor|is-a-geek|is-a-green|is-a-guru|is-a-hard-worker|is-a-hunter|is-a-landscaper|is-a-lawyer|is-a-liberal|is-a-libertarian|is-a-llama|is-a-musician|is-a-nascarfan|is-a-nurse|is-a-painter|is-a-personaltrainer|is-a-photographer|is-a-player|is-a-republican|is-a-rockstar|is-a-socialist|is-a-student|is-a-teacher|is-a-techie|is-a-therapist|is-an-accountant|is-an-actor|is-an-actress|is-an-anarchist|is-an-artist|is-an-engineer|is-an-entertainer|is-certified|is-gone|is-into-anime|is-into-cars|is-into-cartoons|is-into-games|is-leet|is-not-certified|is-slick|is-uberleet|is-with-theband|isa-geek|isa-hockeynut|issmarterthanyou|jpn|kr|likes-pie|likescandy|mex|neat-url|nfshost|no|operaunite|qc|rhcloud|ro|ru|sa|saves-the-whales|se|selfip|sells-for-less|sells-for-u|servebbs|simple-url|space-to-rent|teaches-yoga|uk|us|uy|withgoogle|writesthisblog|za)\\.)?com)" +
    ...
    "|(?:(?:(?:com|gov|org|edu|biz|name|info)\\.)?et)" +
    ...
    "|(?:(?:(?:biz|co|com|edu|gov|info|net|org)\\.)?nr)" +
    ...
    "|(?:(?:(?:[a-ik-pr-uw-z]|ac|bd|blogspot|brand|com|fh|fhsk|fhv|komforb|kommunalforbund|komvux|lanbib|naturbruksgymn|org|parti|pp|press|tm)\\.)?se)" +
    ...
    "|(?:(?:(?:av|bbs|bel|biz|com|dr|edu|gen|gov(?:\\.nc)?|info|k12|kep|mil|name|nc|net|org|pol|tel|tsk|tv|web)\\.)?tr)" +
    ...
    "|(?:(?:(?:ac|bl|british-library|(?:(?:blogspot)\\.)?co|(?:(?:service)\\.)?gov|jet|judiciary|ltd|me|mil|mod|national-library-scotland|nel|net|nhs|nic|nls|org|parliament|plc|police|sch)\\.)?uk)" +
    ...
    "|(?:(?:(?:arts|co|com|e12|edu|firm|gob|gov|info|int|mil|net|org|rec|store|tec|web)\\.)?ve)" +
    "|(?:(?:(?:co|com|k12|net|org)\\.)?vi)" +
    "|(?:(?:(?:ac|biz|com|edu|gov|health|info|int|name|net|org|pro)\\.)?vn)" +
    "|(?:(?:(?:com|edu|net|org)\\.)?vu)" +
    "|(?:(?:(?:com|dyndns|edu|gov|mypets|net|org)\\.)?ws)" +
    "|(?:(?:(?:ак|обр|од|орг|пр|упр)\\.)?срб)" +
    "|(?:abbott|abogado|accountants|active|actor|africa|agency|airforce|allfinanz|alsace|am|amsterdam|aq|aquarelle|archi|army|asia|associates|attorney|auction|audio|autos|ax|axa|band|bar|barcelona|bargains|bauhaus|bayern|bcn|beer|best|bible|bid|bio|black(?:friday)?|bloomberg|bnl|bnpparibas|bond|boo|boutique|brussels|budapest|buzz|bv|bzh|cal |cancerresearch|capetown|capital|caravan|cards|careers?|cartier|casa|cash|cat|catering|cba|cern|cg|channel|cheap|christmas|chrome|church|city|claims|cleaning|click|clinic|coffee|college|cologne|commbank|community|condos|consulting|cooking|cool|coop|country|credit|creditcard|crs|cruises|cuisinella|cymru|dabur|dad|dating|datsun|day|deals|degree|dental|dentist|desi|diet|digital|direct|discount|dj|dnp|doosan|durban|dvag|eat|edu|emerck|engineer|er|erni|esq|eurovision|eus?|events|everbank|exchange|expert|exposed|fail|fan|fashion|feedback|finance|financial|firmdale|fish(?:ing)?|fitness|f