...
var TLD = "(" +
    ...
    "|(?:(?:(?:act|asn|(?:(?:blogspot)\\.)?com|conf|csiro|(?:(?:act|nsw|nt|qld|sa|tas|vic|wa)\\.)?edu|(?:(?:act|nt|qld|sa|tas|vic|wa)\\.)?gov|id|info|net|nsw|nt|org|oz|qld|sa|tas|vic|wa)\\.)?au)" +
    "|(?:(?:(?:com)\\.)?aw)" +
    ...
    "|(?:(?:(?:adm|adv|agr|am|arq|art|ato|b|bio|blog|bmd|cim|cng|cnt|(?:(?:blogspot)\\.)?com|coop|ecn|eco|edu|emp|eng|esp|etc|eti|far|flog|fm|fnd|fot|fst|g12|ggf|gov|imb|ind|inf|jor|jus|leg|lel|mat|med|mil|mus|net|nom|not|ntr|odo|org|ppg|pro|psc|psi|qsl|radio|rec|slg|srv|taxi|teo|tmp|trd|tur|tv|vet|vlog|wiki|zlg)\\.)?br)" +
    ...
    "|(?:(?:(?:(?:(?:(?:(?:ap-(?:northeast-1|southeast-[1-2])|eu-west-1|sa-east-1|us-west-[1-2]|us-gov-west-1)\\.)?compute|(?:z-[1-2]\\.)?compute-1|elb|s3(?:-(?:(?:website-)?(?:ap-(?:northeast-1|southeast-[1-2])|eu-west-1|sa-east-1|us-east-1|us-west-[1-2])|(?:(?:fips|website)-)?us-gov-west-1|website-us-east-1))?)\\.)?amazonaws|appspot|ar|betainabox|blogdns|blogspot|br|cechire|cn|codespot|de|dnsalias|dnsdojo|doesntexist|dontexist|doomdns|dreamhosters|dyn-o-saur|dynalias|dyndns-at-home|dyndns-at-work|dyndns-blog|dyndns-free|dyndns-home|dyndns-ip|dyndns-mail|dyndns-office|dyndns-pics|dyndns-remote|dyndns-server|dyndns-web|dyndns-wiki|dyndns-work|elasticbeanstalk|est-a-la-maison|est-a-la-masion|est-le-patron|est-mon-blogueur|eu|from-ak|from-al|from-ar|from-ca|from-ct|from-dc|from-de|from-fl|from-ga|from-hi|from-ia|from-id|from-il|from-in|from-ks|from-ky|from-ma|from-md|from-mi|from-mn|from-mo|from-ms|from-mt|from-nc|from-nd|from-ne|from-nh|from-nj|from-nm|from-nv|from-oh|from-ok|from-or|from-pa|from-pr|from-ri|from-sc|from-sd|from-tn|from-tx|from-ut|from-va|from-vt|from-wa|from-wi|from-wv|from-wy|gb|getmyip|googleapis|googlecode|gotdns|heroku(?:app|ssl)|hobby-site|homelinux|homeunix|hu|iamallama|is-a-anarchist|is-a-blogger|is-a-bookkeeper|is-a-bulls-fan|is-a-caterer|is-a-chef|is-a-conservative|is-a-cpa|is-a-cubicle-slave|is-a-democrat|is-a-designer|is-a-doctor|is-a-financialadvisor|is-a-geek|is-a-green|is-a-guru|is-a-hard-worker|is-a-hunter|is-a-landscaper|is-a-lawyer|is-a-liberal|is-a-libertarian|is-a-llama|is-a-musician|is-a-nascarfan|is-a-nurse|is-a-painter|is-a-personaltrainer|is-a-photographer|is-a-player|is-a-republican|is-a-rockstar|is-a-socialist|is-a-student|is-a-teacher|is-a-techie|is-a-therapist|is-an-accountant|is-an-actor|is-an-actress|is-an-anarchist|is-an-artist|is-an-engineer|is-an-entertainer|is-certified|is-gone|is-into-anime|is-into-cars|is-into-cartoons|is-into-games|is-leet|is-not-certified|is-slick|is-uberleet|is-with-theband|isa-geek|isa-hockeynut|issmarterthanyou|jpn|kr|likes-pie|likescandy|neat-url|no|operaunite|qc|rhcloud|ru|sa|saves-the-whales|se|selfip|sells-for-less|sells-for-u|servebbs|simple-url|space-to-rent|teaches-yoga|uk|us|uy|writesthisblog|za)\\.)?com)" +
